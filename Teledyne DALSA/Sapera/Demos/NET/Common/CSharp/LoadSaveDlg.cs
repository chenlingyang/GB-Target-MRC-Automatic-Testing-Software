...
namespace DALSA.SaperaLT.SapClassGui
{
   class LoadSaveDlg
   {
      ...
      static ConversionTable[] m_ConversionTable =
      {
         ...
         new ConversionTable(SapFormat.Mono8P5, new int[] {UNSUPPORTED, UNSUPPORTED, NO_CONVERSION, NO_CONVERSION, UNSUPPORTED, UNSUPPORTED}),
         new ConversionTable(SapFormat.Mono8P6, new int[] {UNSUPPORTED, UNSUPPORTED, NO_CONVERSION, NO_CONVERSION, UNSUPPORTED, UNSUPPORTED}),
         new ConversionTable(SapFormat.Mono8P7, new int[] {UNSUPPORTED, UNSUPPORTED, NO_CONVERSION, NO_CONVERSION, UNSUPPORTED, UNSUPPORTED}),
         new ConversionTable(SapFormat.Mono8P8, new int[] {UNSUPPORTED, UNSUPPORTED, NO_CONVERSION, NO_CONVERSION, UNSUPPORTED, UNSUPPORTED}),
         new ConversionTable(SapFormat.Mono8P9, new int[] {UNSUPPORTED, UNSUPPORTED, NO_CONVERSION, NO_CONVERSION, UNSUPPORTED, UNSUPPORTED}),
         new ConversionTable(SapFormat.Mono8P10, new int[] {UNSUPPORTED, UNSUPPORTED, NO_CONVERSION, NO_CONVERSION, UNSUPPORTED, UNSUPPORTED}),
         ...
         new ConversionTable(SapFormat.Mono16P5, new int[] {UNSUPPORTED, UNSUPPORTED, NO_CONVERSION, NO_CONVERSION, UNSUPPORTED, UNSUPPORTED}),
         new ConversionTable(SapFormat.Mono16P6, new int[] {UNSUPPORTED, UNSUPPORTED, NO_CONVERSION, NO_CONVERSION, UNSUPPORTED, UNSUPPORTED}),
         new ConversionTable(SapFormat.Mono16P7, new int[] {UNSUPPORTED, UNSUPPORTED, NO_CONVERSION, NO_CONVERSION, UNSUPPORTED, UNSUPPORTED}),
         new ConversionTable(SapFormat.Mono16P8, new int[] {UNSUPPORTED, UNSUPPORTED, NO_CONVERSION, NO_CONVERSION, UNSUPPORTED, UNSUPPORTED}),
         new ConversionTable(SapFormat.Mono16P9, new int[] {UNSUPPORTED, UNSUPPORTED, NO_CONVERSION, NO_CONVERSION, UNSUPPORTED, UNSUPPORTED}),
         new ConversionTable(SapFormat.Mono16P10, new int[] {UNSUPPORTED, UNSUPPORTED, NO_CONVERSION, NO_CONVERSION, UNSUPPORTED, UNSUPPORTED})
      };
