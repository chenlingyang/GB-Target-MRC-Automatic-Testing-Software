Public Class GigESeqGrabDemodlg
   ...
   Private Shared Sub xfer_XferNotify(ByVal sender As Object, ByVal argsNotify As SapXferNotifyEventArgs)
      Dim GigeDlg As GigESeqGrabDemodlg = TryCast(argsNotify.Context, GigESeqGrabDemodlg)

      GigeDlg.Invoke(New CheckForLastFrameDelegate(AddressOf GigeDlg.CheckForLastFrame))

      If ((GigeDlg.m_Buffers.Index) Mod GigeDlg.m_nFramesPerCallback) = 0 OrElse GigeDlg.m_Buffers.Index = GigeDlg.m_Buffers.Count - 1 Then
         ' Refresh view
         GigeDlg.m_View.Show()
         ' Refresh controls
         GigeDlg.Invoke(New RefreshControlDelegate(AddressOf GigeDlg.RefreshTextBox))
      End If
   End Sub
   ...
   Public Sub New()
      ...
      ' 
      Me.m_ImageBox = New DALSA.SaperaLT.Demos.NET.VB.GigESeqGrabDemo.ImageBox
      Me.m_ImageBox.Location = New System.Drawing.Point(260, 66)
   ...
   Public Function CreateNewObjects(ByVal Nbr_Buffers As Integer, ByVal acConfigDlg As AcqConfigDlg) As Boolean
      ...
      If SapBuffer.IsBufferTypeSupported(m_ServerLocation, SapBuffer.MemoryType.ScatterGather) Then
         m_Buffers = New SapBufferWithTrash(Nbr_Buffers, m_AcqDevice, SapBuffer.MemoryType.ScatterGather)
      Else
         m_Buffers = New SapBufferWithTrash(Nbr_Buffers, m_AcqDevice, SapBuffer.MemoryType.ScatterGatherPhysical)
      End If
   ...
   Private Sub GigESeqGrabDemodlg_FormClosed(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles MyBase.FormClosed
      DestroyObjects()
      DisposeObjects()
   End Sub
   ...
   Private Sub UpdateTextBox()
      ...
      If (m_MinTime <> Single.MaxValue) Then
   ...
   Private Sub button_High_Frame_Rate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles button_High_Frame_Rate.Click
      Dim dlg As New HighFrameDlg(m_nFramesPerCallback, 0, Nothing)
      If dlg.ShowDialog() = Windows.Forms.DialogResult.OK Then
   ...
   Private Sub button_Play_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles button_Play.Click
      ...
      timer.Interval = Math.Max(1, CInt(1000 / Single.Parse(textBox_Frame_Rate.Text)))
      timer.Enabled = True
   ...
   Private Sub button_Load_Sequence_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles button_Load_Sequence.Click
      If m_Buffers.Format = SapFormat.Mono16 Then
