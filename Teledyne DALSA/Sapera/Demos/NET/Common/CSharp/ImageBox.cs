       ...
       private String GetPixelString(Point point)
       {
          ...
          if (m_pView.Buffer != null)
          {
             ...
             switch (format)
             {
                ...
                case SapFormat.Mono8P5:
                case SapFormat.Mono8P6:
                case SapFormat.Mono8P7:
                case SapFormat.Mono8P8:
                case SapFormat.Mono8P9:
                case SapFormat.Mono8P10:
                case SapFormat.Mono16P2:
                case SapFormat.Mono16P3:
                case SapFormat.Mono16P4:
                case SapFormat.Mono16P5:
                case SapFormat.Mono16P6:
                case SapFormat.Mono16P7:
                case SapFormat.Mono16P8:
                case SapFormat.Mono16P9:
                case SapFormat.Mono16P10:
