...
namespace DALSA.SaperaLT.SapClassGui
{
    partial class RawFileDlg
    {
        ...
        private static SapFormatInfo[] m_FormatInfo = 
        {
            ...
            new SapFormatInfo(SapFormat.RGBAP8, "RGB Alpha Planar 8-bit"),
            new SapFormatInfo(SapFormat.RGBAP16, "RGB Alpha Planar 16-bit"),
            ...
            new SapFormatInfo(SapFormat.BICOLOR1212, "BICOLOR 12-bit"),
            ...
            new SapFormatInfo(SapFormat.Mono8P5, "Monochrome 8-bit (5 planes)"),
            new SapFormatInfo(SapFormat.Mono8P6, "Monochrome 8-bit (6 planes)"),
            new SapFormatInfo(SapFormat.Mono8P7, "Monochrome 8-bit (7 planes)"),
            new SapFormatInfo(SapFormat.Mono8P8, "Monochrome 8-bit (8 planes)"),
            new SapFormatInfo(SapFormat.Mono8P9, "Monochrome 8-bit (9 planes)"),
            new SapFormatInfo(SapFormat.Mono8P10, "Monochrome 8-bit (10 planes)"),
            ...
            new SapFormatInfo(SapFormat.Mono16P5, "Monochrome 16-bit (5 planes)"),
            new SapFormatInfo(SapFormat.Mono16P6, "Monochrome 16-bit (6 planes)"),
            new SapFormatInfo(SapFormat.Mono16P7, "Monochrome 16-bit (7 planes)"),
            new SapFormatInfo(SapFormat.Mono16P8, "Monochrome 16-bit (8 planes)"),
            new SapFormatInfo(SapFormat.Mono16P9, "Monochrome 16-bit (9 planes)"),
            new SapFormatInfo(SapFormat.Mono16P10, "Monochrome 16-bit (10 planes)")
        };
    }
}